...
import { FaChevronLeft, FaChevronRight, FaFacebookF, FaInstagram, FaLinkedin, FaPinterestP, FaSnapchatGhost, FaTwitter } from "react-icons/fa";
...
const Topbar = () => {
    return (
        <div className="w-full bg-black text-white text-xs px-6 py-2 flex justify-between items-center">
